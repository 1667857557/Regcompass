...
#' @param significance_threshold Maximum P value displayed as significant. Must
#'   be no greater than `0.05` because star labels use conventional thresholds.
...
rc_plot_condition_reaction <- function(
  ...
  if (any(!is.finite(numeric_controls)) ||
      significance_threshold <= 0 || significance_threshold > 0.05 ||
