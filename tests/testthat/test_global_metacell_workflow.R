test_that("v1.7.0 public workflow is condition pooled", {
  ...
  expect_match(wrapper_text, ".rc_make_condition_pooled_metacells", fixed = TRUE)
  expect_match(wrapper_text, ".rc_run_condition_pando_modules", fixed = TRUE)
  expect_match(wrapper_text, "missing_conditions", fixed = TRUE)
  ...
  expect_match(wrapper_text, ".rc_merge_stratum_meta_modules", fixed = TRUE)
  expect_match(wrapper_text, ".rc_build_condition_pooled_layer1", fixed = TRUE)
