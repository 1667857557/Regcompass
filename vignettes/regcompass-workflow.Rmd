...
Pando `ConditionGRNFit v5` outer-heldout common-support projections are the
primary regulatory input. Reference-condition coefficient effects are retained
...
The primary route uses outer-heldout common-support regulatory scores. RNA-only,
condition-full, depth, zero-pattern, link-saturation, and alpha outputs are
sensitivity or attribution results.
