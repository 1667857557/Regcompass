...
RegCompass supplies `tf_cor = 0.05` and `peak_cor = 0.05` when those candidate-discovery controls are omitted. Explicit user values are preserved. The companion Pando implementation currently applies strict `>` correlation comparisons, so the effective default boundary excludes correlations exactly equal to `0.05`.
